    ...
    if ESS<smcsettings.ESS_bound
        ...
        while (CumAcceptRate<smcsettings.CumAcceptRateBound)
            ...
            if smcsettings.verbose
               ...
               disp(['Cumulative acceptance rate is ' num2str(CumAcceptRate ) ' in iteration ' num2str(counter)]);
                
             %[mean(X);  TransformParam(mean(X))]              
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        if (AcceptRate<smcsettings.ChangeMBound &  filtersettings.Nparticles<smcsettings.NparticlesUpperBound)
